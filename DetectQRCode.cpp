...
//int  getSizeBlock(Mat image)
//{
//	
//
////v::imshow("323", image);
//	//cv::imwrite("D:/Учеба/Сервисный робот/OpenCvDetection/data/tmp.jpg", image);
...
//
//	cv::Canny(image, edges, 100, 200, 3);		// Apply Canny edge detection on the gray image
//
...
//			src.push_back(N);
//			src.push_back(O[3]);
//			return  cv_CalculationOfDimensionsSquare(L, M, O);
//		}
//	}
//	return -1;
//}
